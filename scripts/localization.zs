...
// ====== Custom Item Names are located inside the zzscripts/lang/en_us.lang file.
// ====== Since that file be read after all mods lang files, these names will override them,
// ====== Therefore, simplifying the scripts.
